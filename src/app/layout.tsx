  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="centro-kine";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Centro Kine"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="centro-kine"
          data-primary-color="#0964ff"
          defer
        ></script>
      </head>
